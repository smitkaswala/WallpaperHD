...
public class FavoriteItem {
    ...
    public FavoriteItem(String key_id, String small_image, String full_image, String regular_image) {
        this.key_id = key_id;
    ...
    public String getRegular_image(){return regular_image;}

    public void setRegular_image(String regular_image){this.regular_image = regular_image;}

...
public class SqliteDatabase extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME = "FavoriteButton";
    private static String TABLE_NAME = "favorite_Image";
...
//            Toast.makeText(context, "Not_liked", Toast.LENGTH_SHORT).show();
        }
...
//    Cursor cursor = DB.rawQuery("Select *  from Userdetails", null);
    ...
    public List<FavoriteImage> favoriteImageList() {
        SQLiteDatabase db = this.getReadableDatabase();
        List<FavoriteImage> favModelList = new ArrayList<>();
